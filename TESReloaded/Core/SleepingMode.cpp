...
#if defined(NEWVEGAS)
#define kMessageBoxServeSentenceText 0x00000000
#define kMessageBoxButtonYes 0x00000000
#define kMessageBoxButtonNo 0x00000000
#define kShowSleepWaitMenu 0x007054F0
...
void __cdecl TrackCloseSleepWaitMenu() {
	...
	if (Served) {
		Served = false;
		TheUtilityManager->ShowMessageBox(*MessageBoxServeSentenceText, (void*)0x00671600, *MessageBoxButtonYes, *MessageBoxButtonNo);
	}
